...
import com.myshopnet.client.Auth;
import com.myshopnet.client.Client;
import com.myshopnet.client.Request;
...
public class ChatSessionMenu {
    ...
    public ChatSessionMenu(Client client, String chatId, String otherUserId) {
        this.client = client;
        this.chatId = chatId;
    ...
    public void show() {
        ...
        do {
            ...
            choice = UIUtils.getIntInput(scanner); // ✅ תוקן
    ...
    private void sendMessage() {
        ...
        UIUtils.waitForEnter(scanner); // ✅ תוקן
    }
