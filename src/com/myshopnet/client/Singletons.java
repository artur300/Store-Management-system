...
public class Singletons {
    ...
    // חשוב: להשאיר את ChatMenu כ־ChatMenu (נוח לגישה ישירה אם צריך),
    // אבל בזכות ה-hooks גם אם משתנים ל-Menu זה יעבוד.
    public static final ChatMenu CHAT_MENU = new ChatMenu();
